...
// figure <-> Venator's robed portrait).
//
// Five hero backgrounds also came from files named with old codenames instead of
// hero names. They were originally matched by visual theme and the files renamed to
// match - verified by opening every file: familiar/celeste (moon+city skyline),
// astro/paige (occult pentagram+sigils), fencer/rem (horned/hellish imagery),
// unicorn/holliday (carnival sideshow poster), patience/apollo (mythic horse/rhino
// creature). Note unicorn and patience are the reverse of what their names suggest -
// verify by opening the file before ever renaming one of these again.
...
export const HEROES: HeroDefinition[] = [
  ...
  hero('apollo', 'Apollo', 'apollo_sm_psd.png', 'apollo_card_gloat_psd.png', 'apollo_bg_psd.png', 'apollo'),
  ...
  hero('celeste', 'Celeste', 'celeste_sm_psd.png', 'celeste_card_gloat_psd.png', 'celeste_bg_psd.png', 'celeste'),
  ...
  hero('holliday', 'Holliday', 'holliday_sm_psd.png', 'holliday_gloat_psd.png', 'holliday_bg_psd.png', 'holliday'),
  ...
  hero('paige', 'Paige', 'paige_sm_psd.png', 'paige_card_gloat_psd.png', 'paige_bg_psd.png', 'paige'),
  ...
  hero('rem', 'Rem', 'rem_sm_psd.png', 'rem_card_gloat_psd.png', 'rem_bg_psd.png', 'rem'),
  ...
  hero('venator', 'Venator', 'venator_sm_psd.png', 'venator_card_gloat_psd.png', 'venator_bg_psd.png', 'priest'),
